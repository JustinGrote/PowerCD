...
if (-not $InvokeBuildPath) {
	#Bootstrap it
	Install-Module -Name InvokeBuild -MinimumVersion $MinimumVersion -scope currentuser -verbose -Force
	Import-Module -Name InvokeBuild -MinimumVersion $MinimumVersion -Force
}
